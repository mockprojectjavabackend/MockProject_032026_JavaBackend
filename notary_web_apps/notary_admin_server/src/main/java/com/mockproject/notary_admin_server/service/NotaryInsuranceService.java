...
@Service
public class NotaryInsuranceService {
    ...
    public NotaryInsuranceService(NotaryInsuranceRepository notaryInsuranceRepository, EntityManager entityManager) {
    ...
    public java.util.List<NotaryInsurance> getAllInsurancesByNotaryId(UUID notaryId) {
